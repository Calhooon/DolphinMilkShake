...
**TAAL is the working ARC today**: direct POSTs to `https://arc.taal.com/v1/tx` with `Authorization: REDACTED-TAAL-KEY` return `SEEN_ON_NETWORK` and the tx actually propagates.
